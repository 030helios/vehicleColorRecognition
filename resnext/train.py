...
def main():
    ...
    data_root = os.path.abspath(os.path.join(os.getcwd(), os.pardir))  # get data root path
    ...
    '''
    # load model weights
    # download url: https://drive.google.com/file/d/1JERVqSEMIn9_ghZcKNts0motgMP12EeL/view?usp=sharing
